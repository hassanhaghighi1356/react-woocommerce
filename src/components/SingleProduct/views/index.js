    ...
    <>
      <div className="bg-gray-100 mt-4 p-4 rounded-lg">
        <div className="bg-white rounded-lg">
          ...
          <div className="flex ">
            <div className="text-right text-2xl">دیدگاه خود را درباره این کالا بنویسید.</div>
            <div><svg width="45" height="45" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M19.3737 11.5674C19.3737 14.962 16.0475 17.5816 11.9584 17.6388C10.8853 17.6538 9.82943 17.3931 8.84679 18.0307C8.19864 18.4513 7.48574 18.5481 7.10486 18.5447C7.28168 18.2399 8.27752 17.551 8.05072 16.7837C5.95717 15.6978 4.56445 13.7676 4.56445 11.5674C4.56445 8.17283 7.89364 5.42091 11.9831 5.4209C16.0726 5.4209 19.3737 8.17283 19.3737 11.5674Z" fill="#03C056"/>
</svg></div>
          </div>
          <div><button className="w-10 h-10 rounded-sm bg-gray-100 m-4 p-2 text-center"><svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
  <g clipPath="url(#clip0_167_89)">
    <path d="M10 4.5L6 8.5L10 12.5" stroke="#38394B" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
  </g>
  <defs>
    <clipPath id="clip0_167_89">
      <rect width="16" height="16" fill="white" transform="translate(0 0.5)"/>
          ...
          <div className="text-gray-500 text-lg text-right">با ثبت دیدگاه بر رووی کالا های خریداری شده ۵ امتیاز دریافت کنید.</div>
        </div>
      </div>
    </>
  );
